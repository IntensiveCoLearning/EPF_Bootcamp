...
![image.png](https://raw.githubusercontent.com/IntensiveCoLearning/EPF_Bootcamp/main/assets/JohnBOMBS/images/2026-04-17-1776439202494-image.png)
...
打卡，最近学习的时间很少，我不确定我是否对他有兴趣，但我会在坚持的
...
今天在看WIKI公式的时候发现他和编程语言的逻辑语句不太一样，WIKI写的逻辑语句都是在后面的，在看这些公式的时候总是懵逼，进度也很慢，现在能进入状态了

![image.png](https://raw.githubusercontent.com/IntensiveCoLearning/EPF_Bootcamp/main/assets/JohnBOMBS/images/2026-04-14-1776176724420-image.png)

p是用户需要支付的费用  
f是矿工能收到的费用

![image.png](https://raw.githubusercontent.com/IntensiveCoLearning/EPF_Bootcamp/main/assets/JohnBOMBS/images/2026-04-14-1776177213925-image.png)

_TgasLimit=由我（发出方）设定gas上限_

![image.png](https://raw.githubusercontent.com/IntensiveCoLearning/EPF_Bootcamp/main/assets/JohnBOMBS/images/2026-04-14-1776177252512-image.png)

​  
\_TblobVersionedHashes = blob的数量\_​

![image.png](https://raw.githubusercontent.com/IntensiveCoLearning/EPF_Bootcamp/main/assets/JohnBOMBS/images/2026-04-14-1776177630069-image.png)

算出你能承受的gas费用

![image.png](https://raw.githubusercontent.com/IntensiveCoLearning/EPF_Bootcamp/main/assets/JohnBOMBS/images/2026-04-14-1776177771461-image.png)

预先冻结的总gas押金

![image.png](https://raw.githubusercontent.com/IntensiveCoLearning/EPF_Bootcamp/main/assets/JohnBOMBS/images/2026-04-14-1776178069001-image.png)

开始执行交易

![image.png](https://raw.githubusercontent.com/IntensiveCoLearning/EPF_Bootcamp/main/assets/JohnBOMBS/images/2026-04-14-1776178814181-image.png)

EVM需要的信息  
  

![image.png](https://raw.githubusercontent.com/IntensiveCoLearning/EPF_Bootcamp/main/assets/JohnBOMBS/images/2026-04-14-1776179138209-image.png)

-   **冷访问 (Cold Access)**：去深不见底的地下书库找一本新书（读取硬盘）。非常耗时，所以**收费极贵（比如 2600 Gas）**。
    
-   **热访问 (Warm Access)**：这本书已经被拿出来，放在管理员手边的桌子上了（读取内存）。再看一眼非常快，**收费极便宜（只要 100 Gas）**。  
    这种方法区分了交易访问列表中声明的地址和存储密钥（产生“热”费用）与未包含在列表中的地址和存储密钥（产生“冷”费用）。
    

if Ttype=0_Ttype_​=0: 都是基础的操作 所以是热访问  
  
if Ttype=1∨2∨3_Ttype_​=1∨2∨3: 需要调用其他操作 所以是冷访问  
  
**_合约是存在状态（State）里的_**  
  
  

![image.png](https://raw.githubusercontent.com/IntensiveCoLearning/EPF_Bootcamp/main/assets/JohnBOMBS/images/2026-04-14-1776180325205-image.png)

以太坊底层，每执行完一次调用，EVM 都会吐出一个 **5 元组 $(\\sigma', g', A', z, o)$**。
