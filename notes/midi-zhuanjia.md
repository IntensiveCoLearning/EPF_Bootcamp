...
最后一天才更新中文版🤦，，不过也好，至少终于可以不用忍受翻译不出来的术语了，，更方便以后学习。。
...
今天聊一个技术之外的话题，对未来经济eth到底意味着什么？ 我把它比作房产，不知道还有没有更贴切的
...
如果说预言机是用区块链的方式解决区块链的问题的话,那不只是金融,许多区块链的问题都可以用区块链的方式去解决;比如预测市场,比如 dao,比如链游等等....... 让我最感兴趣的也是这一部分...
